...
function App() {
  ...
  // Declare the swap function to exchange the 'from' and 'to' currencies
  const swap = () => {
    setFrom(to);
    setTo(from);
  ...
  return (
    <>
      <div
        className="w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat bg-slate-950"
        style={{
